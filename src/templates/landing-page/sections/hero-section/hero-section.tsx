        ...
        <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className=" text-body-md text-gray-200">Acompanhe e otimize o seu negócio online</span>
            </div>
          </div>
          ...
          <div className="relative h-[20rem] hidden md:h-full order-first md:order-last items-center justify-center md:flex lg:flex">
            <Image src='/hero-section.svg' alt='Ilustração com ícones de store, tag e sacola'  width={200} height={400} className="h-full w-auto object-contain"/>
          </div>
      </div>
    </section>
  )
